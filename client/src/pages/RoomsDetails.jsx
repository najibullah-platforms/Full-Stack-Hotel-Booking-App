...
const RoomsDetails = () => {
  ...
  return (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-16 lg:px-24 xl:px-32'>
      ...
      <p className='text-2xl font-medium mt-4'>${room.pricePerNight}/night</p>
       ...
       {/* checkin checkout from*/}
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                ...
                <div className='w-px h-15 bg-gray-800/70 max-md:hidden'></div>
                <div className='flex flex-col'>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
               <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam eius aliquam, voluptas labore velit ipsam dicta quae veritatis. Laudantium necessitatibus animi, laboriosam sequi cumque expedita cum consequatur doloremque sunt nisi? Quo, ea! Accusantium, similique itaque! Asperiores animi, quibusdam tempora maxime nulla sint rerum dolorum corrupti magni libero exercitationem iure pariatur.</p>
            </div>
